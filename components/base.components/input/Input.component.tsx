...
export function InputComponent({
  ...
  // Determine actual input type based on visibility toggle
  const actualInputType = isPasswordInput && showPassword ? "text" : props.type;
    ...
    <div className="relative flex flex-col gap-y-0.5">
      ...
      <div className="relative">
        ...
        {isPasswordInput && (
          <FontAwesomeIcon
            className={cn(
              "right-4 input-icon cursor-pointer",
              pcn<CT>(className, "icon"),
        ...
        {/* Regular right icon (only show if not password) */}
